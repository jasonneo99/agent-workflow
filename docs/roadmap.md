...
- [ ] Governed server mode.
  ...
  - Next: decompose the accumulated Agent Workflow-only changes into bounded release candidates, starting with multi-project learning-daemon governance and receipts; validate each slice independently before promotion.
