...
22. [Agent Workflow + Jarvis Shared Brain](agent-workflow-jarvis-shared-brain.md): combine conversational intent, governed workflows, learning, approvals, and signed fleet actions.
