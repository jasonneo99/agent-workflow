...
status, and node size grows with incoming request count so heavily used agents,
stages, and runs stand out. Stage nodes jump to the Stage Matrix, and run nodes
